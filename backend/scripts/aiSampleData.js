/**
 * Sample financial report content shared between:
 *   - scripts/seedSamples.js     (creates Document + Chunk rows for each user)
 *   - scripts/migrateSeedToPdf.js (generates real PDF files for already-seeded docs)
 *
 * Each entry's `text` is what gets embedded AND what gets rendered into a PDF.
 */
const SAMPLES = [
  {
